...
const cbnReports = [
  {
    id: "RPT_FORM_M_SUMMARY",
    name: "RPT_FORM_M_SUMMARY",
    description: "Form M applications summary report",
    category: "CBN RETURNS",
    status: "ACTIVE",
    createdAt: new Date(2025, 0, 15, 10, 45, 46),
  },
  {
    id: "RPT_FORM_A_SUMMARY",
    name: "RPT_FORM_A_SUMMARY",
    description: "Form A invisibles summary report",
    category: "CBN RETURNS",
    status: "ACTIVE",
    createdAt: new Date(2025, 0, 15, 10, 45, 46),
  },
  {
    id: "RPT_FORM_NXP_SUMMARY",
    name: "RPT_FORM_NXP_SUMMARY",
    description: "Form NXP exports summary report",
    category: "CBN RETURNS",
    status: "ACTIVE",
  ...
  },
  {
    ...
    description: "FX utilization monthly report",
    category: "CBN RETURNS",
    status: "ACTIVE",
    createdAt: new Date(2025, 0, 20, 11, 3, 18),
  },
  {
    id: "RPT_OUTSTANDING_LC",
    name: "RPT_OUTSTANDING_LC",
    description: "Outstanding letters of credit report",
    category: "CBN RETURNS",
    status: "ACTIVE",
    createdAt: new Date(2025, 0, 20, 11, 3, 18),
  },
  {
    id: "RPT_TRADE_PORTFOLIO",
    name: "RPT_TRADE_PORTFOLIO",
    description: "Trade finance portfolio report",
    category: "CBN RETURNS",
    status: "ACTIVE",
    createdAt: new Date(2025, 0, 20, 11, 3, 18),
  },
  {
    id: "RPT_IMPORT_RETURNS",
    name: "RPT_IMPORT_RETURNS",
    description: "Monthly import returns report",
    category: "CBN RETURNS",
    status: "ACTIVE",
    createdAt: new Date(2025, 0, 20, 11, 3, 18),
  },
  {
    id: "RPT_EXPORT_PROCEEDS",
    name: "RPT_EXPORT_PROCEEDS",
    description: "Export proceeds repatriation report",
    category: "CBN RETURNS",
    status: "ACTIVE",
    createdAt: new Date(2025, 0, 20, 11, 3, 18),
  },
  {
    id: "RPT_BDC_TRANSACTIONS",
    name: "RPT_BDC_TRANSACTIONS",
    description: "BDC transactions summary report",
    category: "CBN RETURNS",
    status: "ACTIVE",
    createdAt: new Date(2025, 0, 20, 11, 3, 18),
  },
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-semibold text-foreground">CBN Monthly Report Management</h1>
            <p className="text-sm text-muted-foreground">
              Central Bank of Nigeria monthly returns and trade finance reporting
            </p>
          </div>
        </div>
