...
const regulatoryReports = [
  {
    id: "RPT_COMPLIANCE_STATUS",
    name: "RPT_COMPLIANCE_STATUS",
  ...
  {
    id: "RPT_SANCTIONS_SCREENING",
    name: "RPT_SANCTIONS_SCREENING",
    description: "Sanctions screening results report",
    category: "REGULATORY",
    status: "ACTIVE",
    createdAt: new Date(2025, 0, 15, 10, 45, 46),
  },
  {
    id: "RPT_AML_ACTIVITY",
    name: "RPT_AML_ACTIVITY",
    description: "Anti-money laundering activity report",
    category: "REGULATORY",
    status: "ACTIVE",
    createdAt: new Date(2025, 0, 20, 11, 3, 18),
  },
  {
    id: "RPT_KYC_COMPLIANCE",
    name: "RPT_KYC_COMPLIANCE",
  ...
  {
    id: "RPT_RISK_ASSESSMENT",
    name: "RPT_RISK_ASSESSMENT",
  ...
  {
    id: "RPT_SUSPICIOUS_ACTIVITY",
    name: "RPT_SUSPICIOUS_ACTIVITY",
    description: "Suspicious activity monitoring report",
    category: "REGULATORY",
    status: "ACTIVE",
    createdAt: new Date(2025, 0, 20, 11, 3, 18),
  },
  {
    id: "RPT_PEP_MONITORING",
    name: "RPT_PEP_MONITORING",
    description: "Politically exposed persons monitoring report",
    category: "REGULATORY",
    status: "ACTIVE",
    createdAt: new Date(2025, 0, 20, 11, 3, 18),
  },
  {
    id: "RPT_TRANSACTION_MONITORING",
    name: "RPT_TRANSACTION_MONITORING",
    description: "Transaction monitoring alerts report",
    category: "REGULATORY",
    status: "ACTIVE",
    createdAt: new Date(2025, 0, 20, 11, 3, 18),
  },
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-semibold text-foreground">Regulatory Report Management</h1>
            <p className="text-sm text-muted-foreground">
              Compliance status, sanctions screening, and AML activity reports
            </p>
          </div>
        </div>
